...
2.  **`MPCcontrolledSpacecraft.slx`**: The MPC is added to the previous version of the simulator, replacing the PD controller. The debris avoidance algorithm is added and well functioning. Kalman navigation already validated.
