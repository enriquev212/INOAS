function [r_p_full, x_ref_hist, t_ref, meta] = get_nominal_trajectory_from_gnss(Ts, Nsteps, filename)
    ...
    gnss_file = "cov_perturb_POS_s6a_Y24D011_fixed.dat";
    ...
    %% ============================================================
    %  11) LIGHT SMOOTHING OF ECI POSITION ONLY
    % ============================================================
    % La velocidad ya viene transformada correctamente desde ECEF.
    % No se recalcula derivando la posicion ECI.
    ...
    meta.velocity_source = "ECEF gradient transformed to ECI";
    ...
    fprintf("velocity source: ECEF gradient transformed to ECI\n");
    ...
    fprintf("Nota: ahora v_ref viene de v_ECEF + omega x r, no de derivar pos_ECI.\n\n");
